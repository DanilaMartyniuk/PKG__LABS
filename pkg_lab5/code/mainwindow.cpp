...
void MainWindow::paintEvent(QPaintEvent *)
{
    ...
    if(Xmin > Xmax - 1) ui->horizontalSlider->setValue(Xmax - 1);
    Ymin = ui->horizontalSlider_2->value();
    if(Ymin > Ymax - 1) ui->horizontalSlider_2->setValue(Ymax - 1);
    Xmax = ui->horizontalSlider_3->value();
    if(Xmax + 1 < Xmin) ui->horizontalSlider_3->setValue(Xmin + 1);
    Ymax = ui->horizontalSlider_4->value();
    if(Ymax + 1 < Ymin) ui->horizontalSlider_4->setValue(Ymin + 1);
...
{
    if (value > Xmax) {
        ui->horizontalSlider->setValue(Xmax - 1);
    }
}
...
{
    if (value > Ymax) {
        ui->horizontalSlider_2->setValue(Ymax - 1);
    }
...
{
    if (value < Xmin) {
        ui->horizontalSlider_3->setValue(Xmin + 1);
    }
...
{
    if (value < Ymin) {
        ui->horizontalSlider_4->setValue(Ymin + 1);
    }
}
